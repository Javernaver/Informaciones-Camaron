...
@Component({
  selector: 'app-alter-noticia',
  templateUrl: './alter-noticia.component.html',
  styleUrls: ['./alter-noticia.component.sass']
})
export class AlterNoticiaComponent implements OnInit {
